...
def process(sites):
    for data in sites:
        ...
        # Only call WHOIS API if TLD either "com", "net", "edu", or "org"
        # if tld in ["com", "net", "edu", "org"]:
        record("log", "Fetching WHOIS data for site: " + site)
        fetch_whois_data(result, site)
        # else:
        #    record("log", "Skipping WHOIS fetch for site: " + site)
